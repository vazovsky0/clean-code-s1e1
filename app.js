...
var taskCompleted = function () {
  ...
  //Append the task list item to the #todo__container-complete--tasks
  var listItem = this.parentNode;
...
var taskIncomplete = function () {
  ...
  //Append the task list item to the #todo__container-todo__container-todo__container-incomplete--tasks.
  var listItem = this.parentNode;
  incompleteTaskHolder.appendChild(listItem);
  bindTaskEvents(listItem, taskCompleted);
};
